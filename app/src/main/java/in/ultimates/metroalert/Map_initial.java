...
public class Map_initial extends Activity implements OnItemSelectedListener{
	Spinner spinner1, spinner2;
	Button btn;
	int sourcevalue=0;
	int destinationvalue=0;
	String[] values1 = {"Select Source", "AIIMS", "Adarsh Nagar", "Akshardham",
	...
	String[] values2 = {"Select Destination",  "AIIMS", "Adarsh Nagar", "Akshardham",
			"Anand Vihar ISBT", "Arjan Garh", "Ashok Park Main", "Azadpur",
			"Badarpur", "Barakhamba", "Botanical Garden",
			"Central Secretariat", "Chandi Chowk", "Chawri Bazar",
			"Chhattarpur", "Civil Lines", "Dilshad Garden", "Dwarka Mor",
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.map_initial);
			...
			public void onClick(View v) {
				if(sourcevalue!=0){
					if(destinationvalue!=0){
						...
						Intent i3 = new Intent(v.getContext(),Myservice.class);
						i3.putExtra("lat2", lat[destinationvalue]);
						i3.putExtra("lon2", longi[destinationvalue]);
						startService(i3);
						
						Intent i = new Intent(v.getContext(), Mao_final.class);
						i.putExtra("lat1", lat[sourcevalue]);
						i.putExtra("lon1", longi[sourcevalue]);
						i.putExtra("lat2", lat[destinationvalue]);
						i.putExtra("lon2", longi[destinationvalue]);
						startActivity(i);
						
						
						
				Toast.makeText(Map_initial.this,"Source: "+values1[sourcevalue]+",Destination: "+values2[destinationvalue],Toast.LENGTH_SHORT).show();
					finish();
					}else{
						
						
						
						Toast.makeText(Map_initial.this,"complete your information",Toast.LENGTH_SHORT).show();
					}
				}else{
					Toast.makeText(Map_initial.this,"complete your information",Toast.LENGTH_SHORT).show();
				}
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
		...
		destinationvalue =spinner2.getSelectedItemPosition();
